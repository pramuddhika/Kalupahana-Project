        ...
        <div className="flex justify-center gap-8">
          ...
          <div className="card w-5/12 p-6 mt-28">
            ...
            <div className="flex justify-center fornt-inter items-center mb-4">
              ...
              <input type="text" required className="input basis-1/2 rounded-lg p-2"/>
            </div>
            ...
            <div className="flex justify-center fornt-inter items-center mb-4">
              <p className="basis-1/4 text-text-primary font-semibold">Part Name:</p>
              <input type="date" required className="input basis-1/2 rounded-lg p-2"/>
            </div>

            <div className="flex justify-center fornt-inter">
              <p className="basis-1/4 text-text-primary font-semibold mt-3">Quantity:</p>
              <input type="number" required className="input basis-1/2 rounded-lg p-2"/>
            </div>
          ...
          <div className="card w-5/12 mt-28 p-6">
