...
const Update_MechanicNote = () => {
  ...
  const notePart = (
    <div className="flex gap-8 justify-between">
      <div className="relative flex gap-10 my-4 ml-8 w-1/2 mainStyle">
        <p>Message: </p>
        <textarea rows={4} placeholder="Type job update" value={newNote} onChange={handleNoteChange} 
        className="input rounded-lg w-72 p-2" />
